...
def telachave(key):
    ...
    telak = sg.Window(title="Validação", layout=layout, element_justification='c')
...
def telamain():
    ...
    telac = sg.Window(title="Tela de Cadastro", layout=layout, element_justification='c', size=(800,450))
